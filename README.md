...
config.js             修改區：填 Supabase URL 與 anon key
...
### 3. 放上 GitHub Pages
1. 在 GitHub 開一個 repo（例如 `nccusa/qidian-booking`），把這四個檔案 + `supabase/` 資料夾推上去。
...
- 所有人都要填手機（09 開頭 10 碼）；學生另填學號、教職員另填教職員編號、校外人士只填手機。
